      ...
      <div className="hidden print:block border-b-2 border-slate-800 pb-4 mb-6">
        <div className="flex items-start justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-2xl font-black text-slate-900">ரத்னா விலாஸ் (RATNA VILAS)</h1>
              <p className="text-xs text-amber-800 font-extrabold uppercase">பட்டு &amp; ஜவுளி மாளிகை • வணிக அறிக்கை ({tabLabel})</p>
            </div>
          </div>
          <div className="text-right text-xs text-slate-500">
            ...
            <p className="mt-1 text-[10px] text-slate-400">Generated by Ratna Vilas Textile ERP</p>
          </div>
        </div>
      </div>
