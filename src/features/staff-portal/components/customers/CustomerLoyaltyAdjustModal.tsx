        ...
        <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {[
              ...
              <button
                ...
                className={`py-2 rounded-2xl text-xs font-extrabold border transition-all ${
                  type === opt.id
                    ? 'bg-[#2818cf] text-white border-[#2818cf] shadow-md shadow-indigo-600/20'
          ...
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200/80 rounded-2xl text-sm font-bold font-mono text-slate-900 focus:outline-none focus:border-[#2818cf]"
            />
          </div>
