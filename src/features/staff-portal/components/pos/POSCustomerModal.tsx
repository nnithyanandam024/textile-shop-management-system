        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <input
              ...
              className="w-full px-3.5 py-2.5 bg-slate-50 border border-slate-200/80 rounded-2xl text-xs font-semibold text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#2012ad]/20 focus:border-[#2012ad] transition-all"
            />
          </div>
          ...
          <div className="pt-3 flex items-center justify-end gap-2.5 border-t border-slate-100">
            ...
            <button
              ...
              className="px-5 py-2.5 rounded-2xl text-xs font-extrabold bg-[#2012ad] hover:bg-indigo-700 text-white shadow-md shadow-indigo-600/20 transition-all disabled:opacity-50"
            >
