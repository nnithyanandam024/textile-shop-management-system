      ...
      <div className="flex items-center gap-3">
        <div className="relative flex-1">
          <input
            ...
            placeholder="0"
            className="w-full pl-3.5 pr-8 py-2 bg-slate-50 border border-slate-200/80 rounded-2xl text-xs font-extrabold text-slate-900 focus:outline-none focus:ring-2 focus:ring-[#2818cf]/20 focus:border-[#2818cf] transition-all font-mono"
          />
