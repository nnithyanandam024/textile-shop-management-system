...
export function initBrowserMockApi() {
      ...
      biQuery: async (request: any, userContext?: any) => {
        ...
        if (
          ...
          const msg = {
            ...
            source: 'Ratna Vilas RBAC Security Engine',
        ...
        if (isTamil) {
          const msg = {
            ...
            source: 'Ratna Vilas Tamil Retail NLP Engine',
        ...
        const msg = {
          ...
          source: 'Ratna Vilas Business Intelligence Layer',
  ...
  function getMockStaffProfile(user: any) {
    ...
    const base = baseMap[username] || {
      ...
      email: `${user?.username || 'staff'}@ratnavilas.com`,
  ...
  console.log('⚡ [BrowserMockApi] Ratna Vilas Demo Mock Services initialized on window.api with rich textile catalog & POS billing.');
}
